...
const CHAIN = 'tivtaam';
const BASE_URL = 'https://www.tivtaam.co.il/online/he/search?q=';
  ...
  try {
    ...
    const products = await page.evaluate((q) => {
      ...
      containers.forEach(el => {
        ...
        if (priceSource) {
          const text = priceSource.textContent.trim();
